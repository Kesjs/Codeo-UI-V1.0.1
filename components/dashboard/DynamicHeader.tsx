      ...
      <div className="px-4 lg:px-6 py-3">
        <div className="flex flex-col space-y-3">
          ...
          <div className="flex items-center justify-between gap-3">
            {/* Nom de la section active avec trait */}
            <div className="flex flex-col items-center">
              <button
                onClick={() => setIsMenuOpen(!isMenuOpen)}
                className="px-3 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
              >
                <span className="font-medium text-sm text-slate-700 dark:text-slate-300">{currentSection?.title}</span>
              </button>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative" ref={profileMenuRef}>
                ...
                >
                  ...
                  <span className="font-medium text-sm text-slate-700 dark:text-slate-300">Jean Dupont</span>
